...
class Purchases extends MY_Controller
{
    ...
    function get_purchases() {
        ...
        $this->datatables->select($this->db->dbprefix('purchases') . ".id, date, reference, total, note, attachment, " . $this->db->dbprefix('suppliers') . ".name as supplier");
        $this->datatables->from('purchases')
        ->join('suppliers', 'suppliers.id=purchases.supplier_id', 'left');
        if (!($this->Admin || $this->Barman) && !$this->session->userdata('view_right')) {
    ...
    function view($id = NULL) {
        ...
        $this->data['supplier'] = $this->suppliers_model->getSupplierByID($purchase->supplier_id);
