                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
								...
								<div class="form-group">
                                    <?= lang('ws_price', 'ws_price'); ?>
                                    <?= form_input('ws_price', $product->ws_price, 'class="form-control tip" id="ws_price"'); ?>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <div class="well well-sm">
                                        ...
                                        <div class="form-group st">
                                            ...
                                            foreach ($stores_quantities as $sq) {
                                                if ($sq->store_id == $store->id) {
													...
													$ws_price = $sq->ws_price > 0 ? $this->tec->formatDecimal($sq->ws_price) : '';
                                                }
                                            }
                                            ?>
										...
										<div class="form-group" style="margin-bottom:0;">
                                            <?= lang('ws_price', 'ws_price'.$store->id); ?>
                                            <?= form_input('ws_price'.$store->id, set_value('ws_price'.$store->id, $ws_price), 'class="form-control tip" id="ws_price'.$store->id.'" placeholder="'.lang('optional').'"'); ?>
                                        </div>
                                    </div>
                                </div>
                                <?php } } else { ?>
