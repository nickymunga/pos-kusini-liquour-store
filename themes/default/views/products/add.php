                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <?= form_input('ws_price', set_value('ws_price'), 'class="form-control tip" id="ws_price"'); ?>
                                </div>
                                    ...
                                    <div class="well well-sm">
                                        ...
                                        <div class="form-group" style="margin-bottom:0;">
										 ...
										 <div class="form-group" style="margin-bottom:0;">
                                            ...
                                            <?= form_input('ws_price'.$store->id, set_value('ws_price'.$store->id), 'class="form-control tip" id="ws_price'.$store->id.'" placeholder="'.lang('optional').'"'); ?>
                                        </div>
                                    </div>
                                </div>
                                <?php } } else { ?>
