    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table width="100%" class="stable">
                ...
                <tr>
                    <td style="border-bottom: 1px solid #EEE;"><h4><?= lang('mpesa_sale'); ?>:</h4></td>
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                            <span><?= $this->tec->formatMoney($mpesasales->paid ? $mpesasales->paid : '0.00') . ' (' . $this->tec->formatMoney($mpesasales->total ? $mpesasales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                <?php if (isset($Settings->cheque_payment)) { ?>
                <tr>
                ...
                <tr>
                    <td width="300px;" style="font-weight:bold;"><h4><strong><?= lang('total_mpesa'); ?></strong>:</h4>
                    </td>
                    <td style="text-align:right;"><h4>
                            <span><strong><?= $this->tec->formatMoney($mpesasales->paid); ?></strong></span>
                        </h4></td>
                </tr>
            </table>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_hidden('total_mpesa', $mpesasales->total_mpesa); ?>
                            <?= form_input('total_mpesa_submitted', (isset($_POST['total_mpesa_submitted']) ? $_POST['total_mpesa_submitted'] : $mpesasales->total_mpesa), 'class="form-control input-tip" id="total_mpesa_submitted" required="required"'); ?>
                        </div>
                    </div>
                    <div class="col-sm-6">
