    ...
    <div class="wrapper rtl rtl-inv">
        ...
        <header class="main-header">
            <a href="<?= site_url(); ?>" class="logo">
                ...
                <span class="logo-lg"><?= $store->name == 'SimplePOS' ? 'Kusini Liqour Store <b>POS</b>' : $store->name; ?></span>
                <?php } else { ?>
                <span class="logo-mini">KLS</span>
                <span class="logo-lg"><?= $Settings->site_name == 'SimplePOS' ? 'Kusini Liqour Store <b>POS</b>' : $Settings->site_name; ?></span>
                <?php } ?>
            </a>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" id="retail-price" type="button">R-Price</button>
                                <button class="btn btn-outline-secondary" id="ws-price" type="button">WS-Price</button>
                            </div>
                        </div>
                        <div class="form-group">
