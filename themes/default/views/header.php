...
<div class="wrapper rtl rtl-inv">
    ...
    <header class="main-header">
        <a href="<?= site_url(); ?>" class="logo">
            ...
            <span class="logo-lg"><?= $store->name == 'SimplePOS' ? 'Kusini Liquor Store LTD <b>POS</b>' : $store->name; ?></span>
            <?php } else { ?>
            <span class="logo-mini">KLS</span>
            <span class="logo-lg"><?= $Settings->site_name == 'SimplePOS' ? 'Kusini Liquor Store <b>POS</b>' : $Settings->site_name; ?></span>
            <?php } ?>
        </a>
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <?php if (($this->Admin || $this->Barman) && $qty_alert_num && $this->session->userdata('store_id')) { ?>
                    <li>
